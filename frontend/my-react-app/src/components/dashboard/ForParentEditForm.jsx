      ...
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full my-8 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between z-10">
          <h2 className="text-xl font-bold text-gray-900">
            {article ? 'Edit Parent Article' : 'Add New Parent Article'}
          </h2>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Excerpt * <span className="text-xs text-gray-500">(Arabic)</span>
            </label>
            <textarea
              name="excerpt"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Date * <span className="text-xs text-gray-500">(Arabic)</span>
            </label>
            <input
              type="text"
              name="date"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Author * <span className="text-xs text-gray-500">(Arabic)</span>
            </label>
            <input
              type="text"
              name="author"
...
export default ForParentEditForm;
