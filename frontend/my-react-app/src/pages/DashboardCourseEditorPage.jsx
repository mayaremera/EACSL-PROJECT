    ...
    <div className="flex h-screen bg-gray-50">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-800 mb-2">Dashboard Course Editor</h1>
                <p className="text-gray-600 mb-8">
                    Manage and edit your courses here.
                </p>
...
export default DashboardCourseEditorPage
